function createIntensityMovieInBackground(imageData, scalingFactors, x_position, y_position, outputFileName)
    % Number of frames
    ...
    % Create a figure for the movie and position plot (not visible)
    figure('Visible', 'off');
